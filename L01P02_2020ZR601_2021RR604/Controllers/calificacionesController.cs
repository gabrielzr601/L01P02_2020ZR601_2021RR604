...
using L01P02_2020ZR601_2021RR604.Models;

namespace L01P02_2020ZR601_2021RR604.Controllers
{
    public class calificacionesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.calificaciones != null ? 
                          ...
                          Problem("Entity set 'blogContext.calificaciones'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogContext.calificaciones'  is null.");
            }
            var calificaciones = await _context.calificaciones.FindAsync(id);
            if (calificaciones != null)
            {
